...
public partial class Tarifas_Coloadings : System.Web.UI.Page
{
    UsuarioBean user;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int opcion = DB.Validar_Opcion_Usuario(user, 10);
        if (opcion == 0)
        {
    ...
    {
        string sql = " and trct_empresa_id=" + drp_empresa.SelectedValue + " and trct_trctt_id=1 ";
        if (drp_tipo_persona.SelectedValue != "0")
        {
