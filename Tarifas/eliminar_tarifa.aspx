<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="eliminar_tarifa.aspx.cs" Inherits="Tarifas_eliminar_tarifa" %>
    ...
    class="style4">
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <asp:Button ID="btn_buscar" runat="server" Text="Buscar Tarifas" 
                        ...
                        <tr>
                            <td align="center" colspan="2" height="200px" valign="top">
                                <asp:GridView ID="gv_tarifas" runat="server" Font-Size="XX-Small" 
                                    onrowcommand="gv_tarifas_RowCommand" onrowcreated="gv_tarifas_RowCreated" 
                                    onrowdatabound="gv_tarifas_RowDataBound">
                                    <Columns>
