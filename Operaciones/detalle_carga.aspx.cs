...
public partial class reconciliacion_carga_detalle_carga : System.Web.UI.Page
{
    ...
    protected void btn_siguiente_Click(object sender, EventArgs e)
    {
        ...
        #endregion
        Response.Redirect("~/Operaciones/quiz.aspx?empresaID=" + Bean_Sesion.strC2 + "&sistemaID=" + Bean_Sesion.strC4 + "&ttoID=" + Bean_Sesion.strC6 + "&blID=" + Bean_Sesion.strC8 + "&usuID=" + lbl_usuario.Text + "&sID=" + lbl_sesion_id.Text + "");
    }
}