<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="detalle_carga.aspx.cs" Inherits="reconciliacion_carga_detalle_carga" %>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" style=" vertical-align:top; " >
                        ...
                        <tr>
                            <td>
                                No Viaje</td>
                            <td>
                                <asp:Label ID="lbl_no_viaje" runat="server" style="font-weight: 700"></asp:Label>
                            </td>
                        </tr>
                        </table>
                </td>
